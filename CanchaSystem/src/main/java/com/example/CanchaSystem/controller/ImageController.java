...
public class ImageController {
    ...
    public ResponseEntity<?> insertImage(@PathVariable String username, @RequestParam("file") MultipartFile file, @RequestParam("type") ImageType type) {
        ImageData data = service.uploadImage(file, username, type);
