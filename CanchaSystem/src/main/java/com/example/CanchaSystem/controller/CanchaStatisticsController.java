...
public class CanchaStatisticsController {
    ...
    public List<Map<String, Object>> getDailyStats(@PathVariable Long ownerId) {
        ...
        return statsService.getCanchaEarnings(ownerId, today, today);
    }
    ...
    public List<Map<String, Object>> getWeeklyStats(@PathVariable Long ownerId) {
        ...
        return statsService.getCanchaEarnings(ownerId, startOfWeek, endOfWeek);
    }
    ...
    public List<Map<String, Object>> getMonthlyStats(@PathVariable Long ownerId) {
        ...
        return statsService.getCanchaEarnings(ownerId, start, end);
    }
